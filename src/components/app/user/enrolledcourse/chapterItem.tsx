    ...
    return (
        <div className='border p-2 w-full h-36 rounded-lg shadow-sm border-purple-500  flex flex-col'>
            ...
            <div className="flex justify-end mt-2">
                <button onClick={handleChapterWatch} className='text-xs flex items-center gap-2 text-white bg-gradient-to-b from-purple-600 to-purple-700 via-purple-500 px-3 py-2 rounded-full shadow-sm'>
                    <Play size={12} />
